...
final case class CustomerCreated(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[CustomerCreated] {
    @transient
    ...
    def withCustomerId(__v: _root_.scala.Predef.String): CustomerCreated = copy(customerId = __v)
    ...
    def clearCustomer: CustomerCreated = copy(customer = _root_.scala.None)
    def withCustomer(__v: com.reactivebbq.customers.CustomerProtocol.Customer): CustomerCreated = copy(customer = Option(__v))
    ...
    def companion = com.reactivebbq.customers.CustomerProtocol.CustomerCreated
}

object CustomerCreated extends scalapb.GeneratedMessageCompanion[com.reactivebbq.customers.CustomerProtocol.CustomerCreated] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.reactivebbq.customers.CustomerProtocol.CustomerCreated] = this
  def merge(`_message__`: com.reactivebbq.customers.CustomerProtocol.CustomerCreated, `_input__`: _root_.com.google.protobuf.CodedInputStream): com.reactivebbq.customers.CustomerProtocol.CustomerCreated = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.reactivebbq.customers.CustomerProtocol.CustomerCreated] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = CustomerProtocolProto.javaDescriptor.getMessageTypes.get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = CustomerProtocolProto.scalaDescriptor.messages(5)
  ...
  lazy val defaultInstance = com.reactivebbq.customers.CustomerProtocol.CustomerCreated(
    customerId = "",
    customer = _root_.scala.None
  )
  implicit class CustomerCreatedLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.reactivebbq.customers.CustomerProtocol.CustomerCreated]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.reactivebbq.customers.CustomerProtocol.CustomerCreated](_l) {
  ...
  ): _root_.com.reactivebbq.customers.CustomerProtocol.CustomerCreated = _root_.com.reactivebbq.customers.CustomerProtocol.CustomerCreated(
    customerId,
    customer,
    unknownFields
  )
